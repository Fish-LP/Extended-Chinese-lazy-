      ...
      return {
        ...
        blocks: [
          ...
          },
          {
            ...
            text: "将压缩文件以 [TYPE] 输出|压缩级别 [COMPRESSION]",
            arguments: {
              TYPE: {
                type: Scratch.ArgumentType.STRING,
          ...
          },
          {
            opcode: "writeFile",
            blockType: Scratch.BlockType.COMMAND,
            text: "写入文件 [FILE] [CONTENT] 类型 [TYPE]",
            arguments: {
              FILE: {
                type: Scratch.ArgumentType.STRING,
        ...
        menus: {
          ...
          fileMeta: {
            ...
            items: [
              ...
              { text: "修改日期", value: "modification date" },
              { text: "长修改日期", value: "long modification date" },
              { text: "自2000年到修改的天数", value: "modified days since 2000" },
              { text: "unix时间戳", value: "unix modified timestamp" },
              { text: "注释", value: "comment" },
            ],
          },
          setFileMeta: {
            acceptReporters: true,
